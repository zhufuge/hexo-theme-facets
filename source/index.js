...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_debounce__ = __webpack_require__(5);
...
setTriCanvas()
window.addEventListener('resize', __WEBPACK_IMPORTED_MODULE_0_lodash_debounce___default()(setTriCanvas, 150))

/* harmony default export */ __webpack_exports__["a"] = (triCanvas);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__back_to_top___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__back_to_top__);
...
const headerNode = {
  ...
  setCanvas: function(isShow) {
    this.container.setAttribute(
      'style',
      isShow
        ? 'background-image: url(\'' + __WEBPACK_IMPORTED_MODULE_0__trianglify_canvas__["a" /* default */] + '\'); ' +
